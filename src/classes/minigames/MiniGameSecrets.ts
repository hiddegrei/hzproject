...
export default class MiniGameSecrets {
  ...
  constructor(roomNum: number) {
    ...
    //this.loadSecrets()
    this.secrets = [
      ["1", "7", "1", "s", "m", "i", "t", "h", "Rik", "Smith", "17", "17/10/2001", "Utrecht", "Voetbal"],
      ...
      ["1", "8", "0", "m", "i", "g", "a", "3", "Tigo", "Miggon", "18", "18/03/2003", "Malta", "Tennis"],
      ["0", "9", "2", "3", "d", "a", "v", "i", "d", "David", "Hill", "23", "09/23/1975", "Rome", "Koken"],
