...
export default class MGMain {
  ...
  public renderTime() {
    this.writeTextToCanvas(
      `Time left: ${Math.round(this.timeLeft / 1000)}`,
      20,
      100,
      60,
  ...
  public renderAttemptsBlock() {
    ...
    this.ctx.fill();
    this.writeTextToCanvas(
      `Je hebt nog ${this.attempts} pogingen om het wachtwoord te raden, na elke poging kun je zien welke`,
      16,
      110,
      180
    );
