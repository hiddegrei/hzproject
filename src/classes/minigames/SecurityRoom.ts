...
export default class Security extends MGMain {
	 ...
	 */
     private checkKeyboard(keycode: number){
         console.log("key")
        if (keycode===69 && (this.mouseX >= (this.EndXLine1 - Security.DISTANCE)) && (this.mouseX <= (this.EndXLine1 + Security.DISTANCE)) && (this.mouseX >= (this.EndYLine1 - Security.DISTANCE)) && (this.mouseX <= (this.EndYLine1 + Security.DISTANCE))) {
            this.EndXLine1 = this.mouseX;
            this.EndYLine1 = this.mouseY;
            console.log("1");
        } else if (keycode===69 && (this.mouseX >= (this.EndXLine2 - Security.DISTANCE)) && (this.mouseX <= (this.EndXLine2 + Security.DISTANCE)) && (this.mouseX >= (this.EndYLine2 - Security.DISTANCE)) && (this.mouseX <= (this.EndYLine2 + Security.DISTANCE))) {
            this.EndXLine2 = this.mouseX;
            this.EndYLine2 = this.mouseY;
            console.log("2")
        } else if (keycode===69 && (this.mouseX >= (this.EndXLine3 - Security.DISTANCE)) && (this.mouseX <= (this.EndXLine3 + Security.DISTANCE)) && (this.mouseX >= (this.EndYLine3 - Security.DISTANCE)) && (this.mouseX <= (this.EndYLine3 + Security.DISTANCE))) {
