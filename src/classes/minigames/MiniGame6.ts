...
export default class MiniGame6 extends MGMain {
  ...
  constructor(ctx: CanvasRenderingContext2D, room: Room, canvas: HTMLCanvasElement) {
    ...
    this.fullFingerprint = [
      Game.loadNewImage("./img/fingerPrints/resized-fingerprint-1382652_1920.jpg"),
      Game.loadNewImage("./img/fingerPrints/resized-detective-fingerprints-print.png"),
      Game.loadNewImage("./img/fingerPrints/resized-istockphoto-534450004-612x612.jpg"),
    ];
    this.partFingerprint = [
      Game.loadNewImage("./img/fingerPrints/detective-fingerprints-arch.png"),
      Game.loadNewImage("./img/fingerPrints/detective-fingerprints-loop.png"),
      Game.loadNewImage("./img/fingerPrints/detective-fingerprints-whorl.png"),
    ];
